...
int main()
{
    ...
    int graph[V+2][V+2] = { {0,16,13, 0, 0, 0, 0, 0},
                            {0, 0,10,12, 0, 0, 0, 0},
                            {0, 4, 0, 0,14, 0, 0, 0},
                            {0, 0, 9, 0, 0,20, 0, 0},
                            {0, 0, 0, 7, 0, 4, 0, 0},
    ...
    int numberOfsource,numberofEnd;
   // vector<st>source;
    //vector<st>destination;

    cin>>numberOfsource>>numberofEnd;
    ...
    cout << "The maximum possible flow is " << fordFulkerson(graph, 6, 7);
    return 0;
}
